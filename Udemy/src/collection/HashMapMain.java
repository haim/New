...
public class HashMapMain {
	 ...
	 * gelen bir tane değer bulunur. 2. Bir anahtar sadece bir kez varolabilir.
	 * Ancak bir değer birden fazla olabilir. 3. Elementleri tıpkı HashSet gibi
	 * ekleme sırasına göre depolamaz. (HashSet gibi)
	 * 
	 */
