	...
	public void testJapan() {
		...
		for (int i = 0; i < countries.size(); i++) {
			if (countries.get(i).getText().contains("Japan")) {
				...
				System.out.println(countries.get(i).getText().contains("Japan"));
				Assert.assertEquals(countries.get(i).getText().contains("Japan"), true);
		...
		// table[@class = 'wikitable sortable plainrowheaders jquery-tablesorter']//tbody//tr[6]
		// table[@class = 'wikitable sortable" + " plainrowheaders jquery-tablesorter']//thead//th
		int column = 0;
